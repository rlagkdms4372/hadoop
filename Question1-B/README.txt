...
3. Running this comment "hadoop jar Homework2B.jar WordCount /user/haeun/input/city_temperature.csv  /output1" to operate the system.
4. If it doesn't work, then you need to export Homework2B java file to Jar
...
For this question, the key value is the Year, and the value is the average temperature of Asia countries.
