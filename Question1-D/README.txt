...
3. Running this comment "hadoop jar Homework2D.jar WordCount /user/haeun/input/country-list.csv /user/haeun/input/city_temperature.csv /output1" to operate the system.
4. If it doesn't work, then you need to export Homework2D java file to Jar
...
For this question, the key value is the city from both of csv files, and the value is the country and average temperature respectively.
