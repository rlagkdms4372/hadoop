...
3. Running this comment "hadoop jar MyWordCount1.jar WordCount /user/haeun/input/input_hw1.txt /output1" to operate the system.
4. If it doesn't work, then you need to export MyWordCount java file to Jar
