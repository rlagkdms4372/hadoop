...
3. Running this comment "hadoop jar Homework2A.jar WordCount /user/haeun/input/city_temperature.csv  /output1" to operate the system.
4. If it doesn't work, then you need to export Homework2A java file to Jar
...
For this question, the key value is the Region.
